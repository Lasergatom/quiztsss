...
function init(){
    ...
    if (localStorage.getItem("questions")==null){
        localStorage.setItem("questions",JSON.stringify(
            {
                "data":[
                    {"qnum":1,"title":"What is this place?","qimg":"imgs/studio.jpeg","options":["Canteen","Science Lab","Hall","Launguage Studio"],"ans":"D"},
                    {"qnum":2,"title":"What is the latest time to be on time in TSSS?","qimg":"imgs/schoolview.png","options":["8:00","7:55","7:50","8:05"],"ans":"B"},
                    {"qnum":3,"title":"What is this place?","qimg":"imgs/clroom.jpeg","options":["Computer Room","Classroom","Science Lab","Theatre"],"ans":"A"},
                    {"qnum":4,"title":"Where do misbehaving students go?","qimg":"imgs/sleep.png","options":["Library","ILC","General Office","Discipline Room"],"ans":"D"},
                    {"qnum":5,"title":"Who is he?","qimg":"imgs/principal.png","options":["Principal","Vice principal","Discipline Master","Janitor"],"ans":"A"}
